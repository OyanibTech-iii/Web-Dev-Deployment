 ...
 */
final class Version20260404111707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enrollment CHANGE completed_at completed_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enrollment CHANGE completed_at completed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
