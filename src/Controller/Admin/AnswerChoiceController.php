...
#[Route('/admin/answerchoice')]
 class AnswerChoiceController extends AbstractController
{
    #[Route(name: 'app_admin_answer_choice', methods: ['GET'])]
    public function index(AnswerChoiceRepository $answerChoiceRepository): Response
    {
        return $this->render('admin/answer_choice.html.twig', [
            'answer_choices' => $answerChoiceRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_admin_answer_choice_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_answer_choice', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('admin/answer_choice_new.html.twig', [
            'answer_choice' => $answerChoice,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_answer_choice_show', methods: ['GET'])]
    public function show(AnswerChoice $answerChoice): Response
    {
        return $this->render('admin/answer_choice_show.html.twig', [
            'answer_choice' => $answerChoice,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_admin_answer_choice_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, AnswerChoice $answerChoice, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/answer_choice_edit.html.twig', [
            'answer_choice' => $answerChoice,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_answer_choice_delete', methods: ['POST'])]
